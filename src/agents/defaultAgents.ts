...
export const DEFAULT_AGENTS: AgentDefinition[] = [
  {
    ...
    tools: ["list_files", "read_file", "batch_read_files", "grep", "glob", "git_status", "git_diff"],
  ...
  },
  {
    ...
    tools: ["read_file", "batch_read_files", "grep", "glob", "propose_file_edit", "propose_apply_patch"],
    sensitiveActionAllowed: false,
    allowAsSubAgent: true,
    subAgentMaxTurns: 25,
    outputSchemaHint: [
  ...
  },
  {
    ...
    tools: ["read_file", "batch_read_files", "grep", "glob", "propose_shell"],
    sensitiveActionAllowed: false,
    allowAsSubAgent: true,
    subAgentMaxTurns: 15,
    outputSchemaHint: [
  ...
  },
  {
    ...
    tools: ["read_file", "batch_read_files", "grep", "glob", "git_diff", "diagnostics", "propose_file_edit", "propose_shell"],
    sensitiveActionAllowed: false,
    allowAsSubAgent: true,
    subAgentMaxTurns: 30,
    workflowTemplate: [
  ...
  },
  {
    ...
    tools: ["read_file", "batch_read_files", "grep", "glob", "git_diff", "diagnostics"],
    sensitiveActionAllowed: false,
    allowAsSubAgent: true,
    subAgentMaxTurns: 20,
    workflowTemplate: [
